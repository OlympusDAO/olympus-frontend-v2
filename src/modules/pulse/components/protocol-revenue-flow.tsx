      ...
      <div ref={containerRef} className="relative hidden md:block">
        ...
        <div className="flex items-stretch gap-0">
          ...
          <div className="flex flex-1 items-center justify-center px-6">
            <div
              ref={centerRef}
              className="w-full rounded-2xl border border-yellow/15 bg-yellow/6 px-4 py-6 text-center"
            >
              <div className="mb-1 flex items-center justify-center gap-1.5">
                <PulseDot variant="yellow" />
                <p className="text-[10px] font-medium uppercase tracking-widest text-tertiary-t">
                  Weekly Revenue
                </p>
              </div>
          ...
          <div className="flex w-[28%] shrink-0 flex-col justify-center gap-3">
            <div
              ref={buybackRef}
              className="rounded-2xl border border-green/15 bg-green/6 px-4 py-4 text-center"
            >
              <div className="mb-1 flex items-center justify-center gap-1.5">
            ...
            <div
              ref={backingRef}
              className="rounded-2xl border border-green/15 bg-green/6 px-4 py-3 text-center ring-1 ring-green/20"
            >
              <div className="mb-1 flex items-center justify-center gap-1.5">
                <PulseDot variant="green" />
                <p className="text-[10px] font-medium uppercase tracking-widest text-tertiary-t">
