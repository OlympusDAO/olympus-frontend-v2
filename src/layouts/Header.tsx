...
export function Header() {
  ...
  return (
    <header className="flex items-center justify-between pl-[26px] pr-6 py-3 mt-1.5 mb-2 w-full max-w-(--max-content-width) mx-auto">
      <h1 className="text-2xl font-medium text-primary-t">{title}</h1>
      <ConnectButton />
    </header>
  );
}
