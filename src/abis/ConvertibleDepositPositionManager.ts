export default [
  {
    inputs: [
      ...
      { internalType: "address", name: "tokenRenderer_", type: "address" },
    ],
  ...
  {
    inputs: [{ internalType: "address", name: "renderer_", type: "address" }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "wrapped", type: "bool" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "bool", name: "wrap", type: "bool" },
    ],
    name: "PositionSplit",
    type: "event",
  },
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "positionId_", type: "uint256" },
      { internalType: "bytes", name: "additionalData_", type: "bytes" },
    ],
